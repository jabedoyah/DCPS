...
<html>
    ...
    <body>    
        <form action="{$gvar.l__global}Modificar_idea1.php?option=Modificaridea" method="post">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td><select name="ddl" id="mySelect" onchange="myFunction()" >
                                ...
                                {section loop=$ide name=i }
                                    ...
                                    <option value= {$ide[i]->get(descripcion)}>{$ide[i]->get(nombre)}</option>                 
                                {/section}
                    ...
                    <tr>
                        <td>  
                            {section loop=$ide name=i }
                                <a  class=idea_descripcion id=idea_descripcion_{$ide[i]->get(descripcion)}>{$ide[i]->get(descripcion)}</a>                 
                            {/section}
